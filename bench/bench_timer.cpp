...
private:
  std::priority_queue<HeapTimer, std::vector<HeapTimer>,
...
void bench_add(TimerWheel<HeapAlloc> &wheel, NaiveTimerHeap &th,
  ...
  auto elapsed_ns_2 =
      std::chrono::duration_cast<std::chrono::nanoseconds>(end_2 - start_2)
          .count();
  ...
  auto elapsed_ns_3 =
      std::chrono::duration_cast<std::chrono::nanoseconds>(end_3 - start_3)
          .count();
